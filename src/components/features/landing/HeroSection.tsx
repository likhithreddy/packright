...
export function HeroSection() {
  return (
    <div className="flex flex-col items-start max-w-2xl justify-center h-full gap-6 lg:gap-8 z-10">
      <div className="space-y-4">
        <h2 className="text-primary font-bold tracking-widest uppercase text-sm">
          Group Travel, Finally Sorted
        </h2>
        <h1 className="text-4xl sm:text-5xl md:text-6xl xl:text-7xl font-serif font-bold text-foreground leading-[1.1]">
          Pack together, <br />
          <span className="text-primary/90 italic drop-shadow-sm">show up ready.</span>
        </h1>
        <p className="text-base sm:text-lg text-muted-foreground mt-4 lg:mt-6 leading-relaxed max-w-xl">
