...
export function TripBoardMockCard() {
  return (
    <div className="w-full max-w-md mx-auto aspect-[4/3] rounded-[2rem] overflow-hidden flex flex-col shadow-2xl relative shadow-primary/5 border border-border/50">
      {/* Top Banner (Header Graphic) */}
      <div className="h-1/2 w-full bg-gradient-to-br from-primary/80 to-primary relative flex items-center justify-center">
        ...
        <MapPin className="h-12 w-12 text-primary-foreground/90 absolute drop-shadow-md" />
      </div>

      {/* Bottom Content Area */}
      <div className="h-1/2 w-full bg-card p-6 flex flex-col justify-between">
        <div>
          <h3 className="font-serif text-2xl font-bold text-foreground">Smoky Mountains</h3>
